...
Google Apps
  ...
  * não filtrados por licença
  * sem restrições de uso ou compartilhamento
  * sem restrições de uso ou compartilhamento, mesmo comercialmente
  * Sem restrições de uso, compartilhamento ou modificação
  * sem restrições de uso, compartilhamento ou modificação, mesmo comercialmente
...
Encontrar imagens que você pode usar e compartilhar
...
Customize recommendations on your tablet
...
```
  ...
  * `Chrome 112; OS X 10.15.7` é o navegador e sistema operacional em uso.
...
### Atividade nos Serviços do Google
Se a sua Conta do Google estiver conectada e a Atividade na Web e de apps ativada, seus dados de atividade em sites, apps e Serviços do Google poderão ser salvos na Atividade na Web e de apps da sua conta. Algumas atividades podem incluir informações sobre a área geral em que você estava quando usou o serviço do Google. Quando você pesquisa algo usando uma área geral, essa área tem pelo menos 3 km² ou é ampliada até que inclua a localização de pelo menos 1.000 pessoas. Isso ajuda a proteger sua privacidade.
Em alguns casos, áreas que você pesquisou no passado podem ser usadas para estimar um local relevante para sua pesquisa. Por exemplo, se você pesquisar cafés enquanto estiver em Curitiba, o Google poderá mostrar resultados para essa cidade em pesquisas futuras.
Você pode conferir e controlar sua Atividade na Web e de apps na página Minha atividade.
### atividades em sites e apps de terceiros que usam nossos serviços
Sites e apps que integram Serviços do Google, como anúncios e análises de dados, compartilham informações conosco.
Essas informações são coletadas independente do navegador ou do modo de navegação usado. Por exemplo, embora o modo de navegação anônima do Chrome possa ajudar a proteger sua navegação de outras pessoas que usam o dispositivo, sites e apps de terceiros que integram nossos serviços ainda podem compartilhar informações com o Google quando você os visita.
Saiba mais sobre algumas maneiras de controlar as informações compartilhadas ao visitar ou interagir com sites e apps que usam Serviços do Google.
...
Seu dispositivo pode ter sensores que podem ser usados para entender melhor sua localização e movimentação. Por exemplo, um acelerômetro pode ser usado para determinar sua velocidade e um giroscópio pode ser usado para descobrir em que direção você está indo. Saiba mais sobre como usamos as informações de localização.
...
Podemos, por exemplo, coletar informações disponíveis publicamente on-line ou de outras fontes públicas para ajudar a treinar os modelos de IA do Google e criar recursos como o Google Tradutor, os apps do Gemini e os recursos de IA em Cloud. Ou, caso as informações sobre sua empresa apareçam em um site, podemos indexá-las e exibi-las nos Serviços do Google.
### fornecer nossos serviços
Exemplos de como usamos suas informações para fornecer nossos serviços incluem:
  ...
  * Fotos e vídeos enviados para o Google Fotos para ajudar você a criar álbuns, animações e outros conteúdos que podem ser compartilhados. Saiba mais
...
### Informações de voz e áudio
Você pode escolher, por exemplo, se quer que o Google salve uma gravação de áudio na sua Conta do Google durante suas interações com a Pesquisa, o Assistente e o Maps. Quando o dispositivo detecta um comando de ativação de áudio, por exemplo, "Ok Google", o Google grava sua voz e o áudio alguns segundos antes da ativação. Saiba mais
### informações semelhantes relacionadas à sua saúde física ou mental
Se você usa os produtos e apps fitness que oferecemos, como o Fitbit, Pixel Watch, Nest ou Google Fit, coletamos os dados fornecidos por você, como sua altura e seu peso. Também coletamos informações desses apps e dispositivos, como seus padrões de sono, frequência cardíaca, temperatura da pele, calorias queimadas e passos dados.
...
### Lugares que você marcou como casa e trabalho
Você pode salvar lugares importantes na sua Conta do Google, como sua casa ou seu trabalho. Com o endereço de casa ou do trabalho definidos, fica mais fácil fazer as coisas, por exemplo, encontrar rotas ou resultados mais perto desses locais, além de receber anúncios mais úteis.
Você pode editar ou excluir seus endereços de casa e do trabalho a qualquer momento na sua Conta do Google.
### mostrar tendências
...
### nossos usuários
Por exemplo, para evitar abusos e aumentar a transparência e a responsabilização em relação às práticas de moderação de conteúdo on-line, o Google compartilha dados sobre as solicitações de remoção de conteúdo dos nossos serviços com o Lumen, que coleta e analisa essas solicitações para facilitar a pesquisa e ajudar os usuários da Internet a entender os próprios direitos. Saiba mais.
### número de telefone
...
### o público
Por exemplo, tratamos informações sobre solicitações de remoção de conteúdo dos nossos Serviços de acordo com as políticas de remoção de conteúdo do Google ou com a legislação aplicável. Assim, podemos avaliar o pedido, garantir a transparência, melhorar a responsabilização e evitar abusos e fraudes nessas práticas.
...
Por exemplo, os comerciantes podem fazer upload de dados dos programas de cartões de fidelidade para entender melhor a performance das campanhas publicitárias ou incluir essas informações nos resultados da pesquisa ou do Shopping. Apenas fornecemos relatórios agregados aos anunciantes, esses relatórios não revelam informações sobre pessoas específicas.
### serviços específicos do Google
...
São exemplos desses serviços:
  * Google Voice, para fazer e receber chamadas, enviar mensagens de texto e gerenciar o correio de voz
  * Google Meet, para fazer e receber videochamadas
  * Gmail, para enviar e receber e-mails
  * Google Chat, para enviar e receber mensagens
  * Google Duo, para fazer e receber videochamadas e enviar e receber mensagens
...
### usar as informações que coletamos nos nossos serviços
Dependendo das configurações disponíveis, alguns exemplos de como usamos as informações que coletamos nos nossos serviços são descritos a seguir:
  ...
  * O Google app pode usar dados que você armazenou em outros produtos do Google para mostrar conteúdo personalizado, dependendo das suas configurações. Por exemplo, se você tiver pesquisas armazenadas na Atividade na Web e de apps, o Google app poderá mostrar notícias e outras informações sobre seus interesses, como resultados de jogos, com base nas atividades realizadas.
  * Se você conectar sua Conta do Google ao Google Home, poderá gerenciar informações e realizar tarefas com o Google Assistente. Por exemplo, é possível adicionar eventos ao Google Agenda ou receber a programação do dia, pedir atualizações de status sobre o próximo voo ou enviar informações como rotas de carro para o smartphone. Saiba mais
  * Caso você esteja na UE, as decisões que tomar sobre a vinculação dos serviços vão afetar a forma como determinados Serviços do Google podem usar os dados neles.
...
# Liens externes trouvés
- https://www.google.com.br/intl/pt-BR/about/products
- https://www.gstatic.com/policies/privacy/pdf/20240916/pe84lsmf/google_privacy_policy_pt-BR_br.pdf
- https://www.youtube.com/feed/history/search_history?utm_source=pp&hl=pt_BR
- https://www.youtube.com/feed/history?utm_source=pp&hl=pt_BR
- https://ssl.gstatic.com/seekh/intl/en/privacy
- https://kids.youtube.com/privacynotice
- https://protectingchildren.google/?hl=pt_BR
- https://about.google/
- https://transparency.google/?hl=pt_BR
# Sign in
...
Configurações de pesquisa
Fazer login
AtividadeQuando a personalização da pesquisa está ativada, o Google usa as pesquisas deste navegador para fornecer resultados e recomendações mais relevantes
Personalização da pesquisaAtivada
ConteúdoGerencie os tipos de resultados de pesquisa que você encontra definindo preferências para personalização e conteúdo explícito
SafeSearchFiltro ativadoDesativadaDesfoque ativado
Mais opções
Controles da família no Family Link
FeedbackAjudaPrivacidadeTermos
IdiomaGerencie o idioma de exibição da Pesquisa Google e selecione as preferências para seus resultados
Idioma e região
Área de trabalhoPersonalize a aparência e o funcionamento da Pesquisa Google no seu dispositivo
Tema escuroAtivadaDesativadaPadrão do dispositivo
Tema escuro
Ativada
Desativada
...
Respostas faladas
Preencher automaticamente com as pesquisas em alta
FeedbackAjudaPrivacidadeTermos
Não é possível atualizar a configuração no momento


# Liens externes trouvés
- https://families.google/familylink/?utm_source=google&utm_medium=pref-page&hl=pt-BR&authuser=0
# Fazer login
Use sua Conta do Google
E-mail ou telefone
Esqueceu seu e-mail?
...
Brazil
AboutAdvertisingBusiness How Search works 
PrivacyTerms
Settings
Search settings
Advanced search
...
# Liens externes trouvés
- https://www.google.com.br/intl/en/about/products
- https://about.google/?utm_source=google-BR&utm_medium=referral&utm_campaign=hp-footer&fg=1
# Fazer login
Use sua Conta do Google
E-mail ou telefone
